...
function PerfilEchoLink(props) {
  ...
  const linkPerfil = () => {
    window.open(`https://project-vibrato.netlify.app/artists/${props.username}`, '_blank');
  ...
  const handleCopyToClipboard = () => {
    const link = `https://project-vibrato.netlify.app/echolink/${id}`;
  ...
  const url = "https://vibratosimages.blob.core.windows.net/imagens/"
  return (
